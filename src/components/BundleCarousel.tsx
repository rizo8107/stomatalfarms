    ...
    <div className="w-full min-w-0">
      ...
      >
        ...
        <div className="w-full relative">
          ...
          <div className="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-[#1c1408] to-transparent" />
        </div>

        {/* BOTTOM — info */}
        <div className="p-6 md:p-8 flex flex-col gap-5 min-w-0">
          {/* Badge */}
          <span className="w-fit px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border border-[#f5c842]/40 text-[#f5c842]">
            Most Popular
          </span>
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              {BULLET_POINTS.map((point) => (
                <li key={point} className="flex items-start gap-2 text-xs md:text-sm text-white/60 leading-snug">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {hasDiscount && (
              <>
                <span className="text-base text-white/30 line-through">₹{Math.round(originalPrice)}</span>
                <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wider bg-[#f5c842] text-[#1a1000]">
                  Save ₹{saving}
                </span>
              </>
            )}
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-full text-[11px] font-black uppercase tracking-[0.15em] text-[#1a1000] transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#f5c842]/20"
            ...
            <Link
              ...
              className="flex items-center px-6 py-3 rounded-full text-[11px] font-black uppercase tracking-[0.15em] text-white/60 border border-white/15 transition-all hover:border-white/30 hover:text-white"
            >
              Details
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex items-end justify-between mb-6">
          <div>
            ...
            >
              The <span className="italic text-[#f5c842]">Aurora Bundle</span>
            </h2>
          </div>
